      ...
      <div class="sub-card-contact">
        ...
        <div class="top">
          <div class="my-4">
              ...
              " autocomplete="off" id="name" type="text" name="name" value="{{$dish->name}}">
              @error('name')
                  <p>{{ $message }}</p>
              @enderror
          </div>
          ...
          <div class="my-4">
              ...
              <input class="form-control
              " autocomplete="off" id="ingredients" type="text" name="ingredients" value="{{$dish->ingredients}}">
              @error('ingredients')
                  <p>{{ $message }}</p>
              @enderror
          </div>
          ...
          <div class="my-4">
              ...
              <input class="form-control
              " autocomplete="off" id="description" type="text" name="description" value="{{$dish->description}}">
              @error('description')
                  <p>{{ $message }}</p>
              @enderror
          </div>
          ...
          <div class="my-4">
              ...
              <input class="form-control
              " autocomplete="off" id="price" type="number" step=".01" name="price" value="{{$dish->price}}">
              @error('price')
                  <p>{{ $message }}</p>
              @enderror
          </div>
