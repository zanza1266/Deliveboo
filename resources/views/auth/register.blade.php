                    ...
                    <div class="card-body container-fluid">
                        <div class="row">
                            ...
                            <form class="col-md-7 col-sm-12" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    <label for="name_p_iva" class="col-md-4 col-form-label text-md-right">{{ __('Nome P.Iva') }}</label>
